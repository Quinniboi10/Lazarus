...
inline Square& operator++(Square& s, int) { return s = static_cast<Square>(s + 1); }
inline Square& operator--(Square& s, int) { return s = static_cast<Square>(s - 1); }
constexpr Square operator+(const Square s, const Direction d) { return static_cast<Square>(s + static_cast<int>(d)); }
constexpr Square operator-(const Square s, const Direction d) { return static_cast<Square>(s- static_cast<int>(d)); }
